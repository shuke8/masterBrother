$(document).ready(function () {
  ...
  function SliderWhite() {
    ...
    $("#UzBtn").css({ "background-position": "30px 0" });
    $("#RusBtn").css({ "background-position": "60px 0" });
    $("#EngBtn").css({ "background-position": "90px 0" });
    $(".ParallexBtnS div")
      .stop()
      .animate(
  ...
  function SliderBlack() {
    ...
    $("#UzBtn").css({ "background-position": "90px 0" });
    $("#RusBtn").css({ "background-position": "120px 0" });
    $("#EngBtn").css({ "background-position": "150px 0" });
    $(".ParallexBtnS div")
      .stop()
      .animate(
        { backgroundColor: "#ffea00", opacity: "1" },
